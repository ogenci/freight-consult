...
export default function CTASection() {
  ...
  return (
    <section id="contact" ref={ref} className="relative overflow-hidden bg-[#002318] border-t border-white/8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-28 lg:py-40 text-center">
        <motion.div
          initial="hidden"
        ...
        >
          ...
          <div className="overflow-hidden mb-2">
            <motion.h2 variants={clipReveal} custom={0.05}
              className="text-5xl lg:text-8xl font-display font-bold tracking-[-0.02em] leading-[0.9] text-white"
            >
              Ready to move
            </motion.h2>
          </div>
          <div className="overflow-hidden mb-12">
            <motion.h2 variants={clipReveal} custom={0.15}
              className="text-5xl lg:text-8xl font-display font-bold tracking-[-0.02em] leading-[0.9] text-[#55ed9d]"
            >
              continents?
            </motion.h2>
          </div>
          <motion.p variants={fadeUp} custom={0.22} className="text-white/45 text-lg mb-12 max-w-xl mx-auto leading-relaxed">
            Partner with Africa's most trusted freight forwarding and logistics company. Available 24/7 for urgent cargo needs.
          </motion.p>
          <motion.div variants={fadeUp} custom={0.28} className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
            <a href="mailto:info@freightconsult.com" data-testid="button-cta-quote"
              className="group inline-flex items-center justify-center gap-3 bg-[#55ed9d] text-[#004737] pl-10 pr-5 h-14 font-bold text-sm tracking-widest uppercase rounded-full hover:bg-[#55ed9d]/80 transition-all duration-300"
            >
              Request a Quote
            ...
            <a href="tel:+233240000000" data-testid="button-cta-contact"
              className="group inline-flex items-center justify-center gap-3 border border-white/15 text-white/65 px-8 h-14 font-semibold text-sm tracking-widest uppercase rounded-full hover:border-white/30 hover:text-white transition-all duration-300"
            >
          ...
          <motion.div variants={fadeUp} custom={0.35} className="flex items-center justify-center gap-2 text-white/30">
            ...
            <span className="text-[11px] font-semibold tracking-[0.25em] uppercase">Available 24 / 7 for urgent cargo needs</span>
          </motion.div>
        </motion.div>
      </div>
    </section>
