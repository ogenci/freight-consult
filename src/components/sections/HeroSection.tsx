    ...
    <section ref={ref} className="relative min-h-[80dvh] sm:min-h-[100dvh] flex flex-col justify-end overflow-hidden bg-[#002318]">
      ...
      <motion.div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 w-full pb-10 sm:pb-20 lg:pb-28" style={{ opacity: fade }}>
        <motion.div initial="hidden" animate="visible" variants={stagger}>
          <motion.div variants={fadeUp} custom={0.1} className="flex items-center gap-3 mb-4 sm:mb-8">
            <div className="w-8 sm:w-10 h-[2px] bg-white/60 rounded-full" />
            <span className="text-[9px] sm:text-[11px] font-bold tracking-[0.3em] uppercase text-white/80">Primary PSA BDP Agent · Ghana</span>
          </motion.div>

          <div className="overflow-hidden mb-1">
            <motion.h1 variants={clipReveal} custom={0.15}
              className="text-[clamp(2rem,6vw,5.5rem)] sm:text-[clamp(2.8rem,7vw,5.5rem)] font-display font-bold leading-[0.92] tracking-[-0.03em] text-white"
            >
              We Move Africa's
            </motion.h1>
          </div>
          <div className="overflow-hidden mb-5 sm:mb-8">
            <motion.h1 variants={clipReveal} custom={0.28}
              className="text-[clamp(2rem,6vw,5.5rem)] sm:text-[clamp(2.8rem,7vw,5.5rem)] font-display font-bold leading-[0.92] tracking-[-0.03em]"
            >
          ...
          <motion.p variants={fadeUp} custom={0.38}
            className="text-[13px] sm:text-[15px] md:text-[17px] text-white/80 max-w-md leading-relaxed mb-6 sm:mb-10 font-light"
          >
          ...
          <motion.div variants={fadeUp} custom={0.45} className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <a href="#contact" data-testid="button-hero-primary"
              className="group inline-flex items-center justify-center gap-2 sm:gap-3 bg-[#55ed9d] text-[#004737] pl-6 sm:pl-8 pr-3 sm:pr-4 h-11 sm:h-13 font-bold text-xs sm:text-sm tracking-widest uppercase rounded-full hover:bg-[#55ed9d]/80 transition-all duration-300"
            >
              Request a Quote
              <span className="w-6 sm:w-8 h-6 sm:h-8 rounded-full bg-[#004737]/15 flex items-center justify-center transition-transform group-hover:translate-x-[2px] group-hover:-translate-y-[1px]">
                <ArrowUpRight className="w-3 sm:w-3.5 h-3 sm:h-3.5" />
              </span>
            </a>
            <a href="#services" data-testid="button-hero-secondary"
              className="group inline-flex items-center justify-center gap-2 sm:gap-2.5 border border-white/25 text-white px-5 sm:px-7 h-11 sm:h-13 font-semibold text-xs sm:text-sm tracking-widest uppercase rounded-full hover:border-white transition-all duration-300"
            >
              Explore Services
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-2 sm:grid-cols-4 *:border-r *:border-white/20 [&>*:nth-child(2n)]:border-r-0 sm:[&>*:nth-child(2n)]:border-r sm:[&>*:nth-child(4)]:border-r-0">
          {[
            ...
            <div key={s.l} className="py-3 sm:py-4 px-2 sm:px-4 lg:px-10 text-center">
              <div className="text-lg sm:text-2xl font-display font-bold text-white">{s.v}</div>
