        ...
        <div className="grid lg:grid-cols-[1.2fr_1fr] gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-4 sm:gap-6">
            ...
            <div className="bg-white border border-border rounded-2xl p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
              <Reveal>
                <motion.div variants={fadeUp} custom={0.1} className="flex sm:block justify-center gap-8 sm:gap-0 sm:text-center sm:space-y-7">
                  {[
                    { v: "2006", l: "Founded" },
    ...
    <section ref={ref} className="bg-surface-elevated border-t border-border">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        <Reveal className="mb-10 sm:mb-16">
          ...
          <div className="overflow-hidden mb-1">
            <motion.h2 variants={clipReveal} custom={0.05} className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold tracking-tight text-foreground">
              How We Move
            </motion.h2>
          </div>
          <div className="overflow-hidden">
            <motion.h2 variants={clipReveal} custom={0.12} className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold tracking-tight text-[#004737]/50">
              Your Cargo.
            </motion.h2>
          </div>
        </Reveal>

        <div className="grid lg:grid-cols-[1fr_420px] gap-6 sm:gap-8 items-start">
          <div className="grid sm:grid-cols-2 gap-4 sm:gap-5">
            {processSteps.map((s, i) => (
              <motion.div
                ...
                className="group relative border border-border bg-white p-5 sm:p-7 hover:shadow-[0_8px_30px_rgba(0,35,24,0.10)] transition-all duration-300 overflow-hidden rounded-xl"
              >
                <div className="absolute -top-4 -right-2 text-7xl sm:text-8xl font-display font-bold text-foreground/[0.03] leading-none select-none">{s.n}</div>
                <div className="relative z-10">
                  <div className="w-10 sm:w-11 h-10 sm:h-11 rounded-xl bg-[#002318] flex items-center justify-center text-white mb-4 sm:mb-5">{s.icon}</div>
          ...
          <div className="relative overflow-hidden h-[280px] sm:h-[460px] lg:h-full min-h-[240px] sm:min-h-[380px] img-hover-zoom rounded-2xl">
            <motion.img
            ...
            <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6">
              <div className="bg-white/95 backdrop-blur-sm p-4 sm:p-5 rounded-xl">
                <div className="flex items-center gap-2 mb-1 sm:mb-2">
                  <CheckCircle2 className="w-4 h-4 text-brass shrink-0" />
                  <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] text-[#002318]">Real-Time Visibility</span>
                </div>
    ...
    <section id="impact" ref={ref} className="bg-[#002318] border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        <Reveal className="mb-10 sm:mb-16">
          ...
          <div className="overflow-hidden mb-1">
            <motion.h2 variants={clipReveal} custom={0.05} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight leading-[1.0] text-white">
              Operating Where
            </motion.h2>
          </div>
          <div className="overflow-hidden">
            <motion.h2 variants={clipReveal} custom={0.12} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight leading-[1.0] text-white/15">
              Others Cannot.
            </motion.h2>
          </div>
        </Reveal>

        <div className="grid lg:grid-cols-[1fr_480px] gap-6 sm:gap-8 items-start">
          <div className="space-y-3 sm:space-y-4">
            {items.map((d, i) => (
              <motion.div
                ...
                className="group grid grid-cols-1 sm:grid-cols-[80px_1fr] overflow-hidden rounded-xl border border-white/10 hover:border-brass/30 transition-all duration-300"
              >
                <div className="relative overflow-hidden h-32 sm:h-full">
                ...
                <div className="p-5 sm:p-6 bg-white/[0.03] group-hover:bg-white/[0.06] transition-colors">
                  ...
                  <h3 className="font-display font-bold text-white text-[15px] sm:text-[16px] mb-2">{d.title}</h3>
                  <p className="text-[12px] sm:text-[13px] text-white/45 leading-relaxed">{d.body}</p>
                </div>
              </motion.div>
            ))}
          </div>
...
export function StatsSection() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#002318]">
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-16 sm:py-20 lg:py-28">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 border border-white/10 rounded-2xl overflow-hidden">
          {[
            ...
            <motion.div
              ...
              animate={inView ? { opacity: 1, y: 0 } : {}}
              transition={{ duration: 0.6, ease: EASE, delay: i * 0.08 }}
              className="p-6 sm:p-8 lg:p-12 flex flex-col items-center border-r border-white/10 last:border-r-0 border-b lg:border-b-0"
            >
              <div className="w-full flex justify-center text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-white leading-none mb-2 sm:mb-3">
                <CountUp end={s.end} suffix={s.suffix} />
              </div>
              <div className="text-[9px] sm:text-[10px] font-semibold tracking-[0.25em] uppercase text-white/40 text-center">{s.label}</div>
            </motion.div>
          ))}
        </div>
      </div>
    ...
    <section ref={ref} className="bg-background border-t border-border">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        <Reveal className="text-center mb-10 sm:mb-16">
          ...
          <div className="overflow-hidden mb-1">
            <motion.h2 variants={clipReveal} custom={0.05} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-foreground">
              Accreditations &amp;
            </motion.h2>
          </div>
          <div className="overflow-hidden mb-4 sm:mb-5">
            <motion.h2 variants={clipReveal} custom={0.12} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-[#004737]/50">
              Memberships.
            </motion.h2>
          </div>
          <motion.p variants={fadeUp} custom={0.18} className="text-muted-foreground max-w-xl mx-auto text-sm leading-relaxed px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {accreditations.map((a, i) => (
            <motion.div
              ...
              className="group perspective-[1000px] h-56 sm:h-64"
            >
        ...
        <Reveal className="mt-10 sm:mt-12">
          <motion.div variants={fadeUp} custom={0.1}
            className="bg-[#002318] text-white p-6 sm:p-8 lg:p-10 flex flex-col lg:flex-row items-center justify-between gap-6 rounded-2xl"
          >
            <div className="text-center lg:text-left">
              <div className="text-[11px] font-semibold tracking-[0.3em] uppercase text-white/70 mb-2">Network Reach</div>
              <div className="text-xl sm:text-2xl font-display font-bold">Part of the PSA BDP Global Network</div>
            </div>
    ...
    <section ref={ref} className="bg-surface border-t border-border">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        <Reveal className="mb-10 sm:mb-16">
          ...
          <div className="overflow-hidden mb-1">
            <motion.h2 variants={clipReveal} custom={0.05} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-foreground">The Verdict From</motion.h2>
          </div>
          <div className="overflow-hidden">
            <motion.h2 variants={clipReveal} custom={0.12} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-[#004737]/50">Industry Leaders.</motion.h2>
          </div>
        </Reveal>
        ...
        >
          <div className="relative bg-[#002318] rounded-2xl overflow-hidden">
            <div className="p-6 sm:p-8 lg:p-12 lg:pr-20">
              <span className="text-5xl sm:text-6xl lg:text-8xl font-display font-bold text-[#55ed9d]/10 leading-none block mb-2">&ldquo;</span>
              <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-white/90 mb-8 sm:mb-10 max-w-3xl">
                {heroQuote.text}
              </p>
              <div className="flex items-center gap-3 sm:gap-4 pt-5 sm:pt-6 border-t border-white/8">
                <div className="w-9 sm:w-10 h-9 sm:h-10 rounded-full bg-[#55ed9d]/15 flex items-center justify-center text-[#55ed9d] font-display font-bold text-xs">{heroQuote.initials}</div>
                <div>
                  <div className="font-display font-semibold text-[13px] sm:text-sm text-white">{heroQuote.author}</div>
                  <div className="text-[9px] sm:text-[10px] font-medium tracking-[0.2em] uppercase text-white/40">{heroQuote.role}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-5">
          {secondaryQuotes.map((t, i) => (
            <motion.div
              ...
              className="group bg-white border border-border rounded-xl p-6 sm:p-7 lg:p-8 hover:border-brass/25 hover:shadow-[0_8px_24px_rgba(0,0,0,0.04)] transition-all duration-400"
            >
              <span className="text-2xl font-display font-bold text-brass/15 leading-none block mb-2 sm:mb-3">&ldquo;</span>
              <p className="text-sm text-muted-foreground leading-relaxed mb-5 sm:mb-6">
                {t.text}
              </p>
    ...
    <section ref={ref} className="bg-surface border-t border-border">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        <Reveal className="mb-10 sm:mb-16">
          ...
          <div className="overflow-hidden mb-1">
            <motion.h2 variants={clipReveal} custom={0.05} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-foreground">Where We</motion.h2>
          </div>
          <div className="overflow-hidden mb-4 sm:mb-5">
            <motion.h2 variants={clipReveal} custom={0.12} className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold tracking-tight text-[#004737]/50">Move Industries.</motion.h2>
          </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((ind, i) => (
            ...
            >
              <div className="relative h-56 sm:h-72 overflow-hidden img-hover-zoom">
    ...
    <section ref={ref} className="bg-[#faf8f5] border-t border-border/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-20 sm:py-24 lg:py-32">
        ...
        <motion.div
          ...
          className="grid lg:grid-cols-5 gap-6 sm:gap-0 lg:gap-10 items-start"
        >
          ...
          <div className="lg:col-span-3 mt-0 sm:mt-6 lg:mt-0">
            ...
            <div className="flex items-center gap-4 sm:gap-5 pt-5 sm:pt-6 border-t border-border/50">
